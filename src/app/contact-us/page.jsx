...
import { FaFacebook, FaTwitter, FaPinterest, FaLinkedin, FaPaperPlane, FaGooglePlusG, FaPhone, FaMailBulk, FaAddressCard } from 'react-icons/fa';
                    ...
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="lg:w-1/2 md:w-1/2 w-full mb-10 md:mb-0">
                            <div className="bg-white p-8 rounded-lg shadow-lg">
                                <div className="mb-6">
                                    <h3 className="text-4xl font-semibold text-darkblue">Get In Touch</h3>
                                ...
                                <form id="contact_form" action="#">
                                    <div className="space-y-6">
                                        <div>
                                            <input name="name" type="text" placeholder="Name*" className="w-full px-4 py-3 border border-darkblue" />
                                        </div>
                                        <div>
                                            <input name="email" type="email" placeholder="Email*" className="w-full px-4 py-3 border border-darkblue" />
                                        </div>
                                        <div>
                                            <input name="subject" type="text" placeholder="Subject*" className="w-full px-4 py-3 border border-darkblue" />
                                        </div>
                                        <div>
                                            <textarea name="message" placeholder="Your Message*" className="w-full px-4 py-3 border border-darkblue h-40"></textarea>
                                        </div>
                                        <div>
                                            <input type="submit" className="w-[30%] bg-rosesecondary text-darkblue py-2 sm:py-3 rounded text-sm sm:text-base hover:bg-darkblue hover:text-mild transition-all duration-300 ease-in-out transform" value="SEND" />
                        ...
                        <div className="lg:w-5/12 lg:ml-auto md:w-1/2 w-full p-5">
                            <div className="bg-white p-8 rounded-lg">
                                <div className="mb-6">
                                    <h3 className="text-3xl font-bold text-darkblue">Contact Us</h3>
                                    <div className="flex w-full h-0.5 justify-start items-start my-4">
                                        <div className="w-[25%] h-full bg-darkblue"></div>
                                        <div className="w-[25%] h-full bg-rosesecondary"></div>
                                    </div>
                                ...
                                <ul className="space-y-6">
                                    <li className="flex items-center space-x-4">
                                        <a href="#" className="border-darkblue border text-darkblue hover:bg-darkblue hover:text-mild rounded-full  w-8 h-8 flex items-center justify-center">
                                            <FaPhone />
                                        </a>
                                    ...
                                    <li className="flex items-center space-x-4">
                                        <a href="#" className="border-darkblue border text-darkblue hover:bg-darkblue hover:text-mild rounded-full  w-8 h-8 flex items-center justify-center"><FaMailBulk /></a>
                                        <p className="text-darkblue">
                                            <a href="#" className="block">urname@email.com</a>
                                            <a href="#" className="block">urwebsite@name.com</a>
                                        </p>
                                    </li>
                                    <li className="flex items-center space-x-4">
                                        <a href="#" className="border-darkblue border text-darkblue hover:bg-darkblue hover:text-mild rounded-full  w-8 h-8 flex items-center justify-center"><FaAddressCard /></a>
                                        <p className="text-darkblue">
